...
const StockPage = (props) => {
    ...
    //force update
    const [forceUpdateValue, setForceUpdateValue] = useState(""); 
    // let forceUpdateValue = 0;
            ...
            <div className='stockPageContent container'>
                ...
                {exists === 1 && <div className='stockPageTop'>
                    ...
                    <Button onClick={async () => {
                        await addToWatchlist(ticker).then(
                            (result) => {
                                // force update
                                //the force update isnt setting for some reason
                                // setForceUpdateValue(1);
